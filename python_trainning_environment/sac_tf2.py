...
class Agent:
    def __init__(self, alpha=0.0001, beta=0.0001, input_dims=[8],
            env=None, gamma=0.98, n_actions=2, max_size=1000000, tau=0.005,
            layer1_size=256, layer2_size=256, batch_size=512, reward_scale=0.65,
            start_steps=350000):
        self.gamma = gamma
        self.tau = tau
    ...
    def choose_action(self, observation):
        ...
        actions, _ = self.actor.sample_normal(state, self.start_steps)
    ...
    def learn(self):
        ...
        with tf.GradientTape() as tape:
            ...
            current_policy_actions, log_probs = self.actor.sample_normal(states, self.start_steps)
        ...
        with tf.GradientTape() as tape:
            ...
            new_policy_actions, log_probs = self.actor.sample_normal(states, self.start_steps)
            log_probs = tf.squeeze(log_probs, 1)
